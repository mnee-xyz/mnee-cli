...
class Certificate {
    ...
    toBinary(includeSignature = true) {
        ...
        if (includeSignature && ((_a = this.signature) !== null && _a !== void 0 ? _a : '').length > 0) { // ✅ Explicitly handle nullish signature
            const signatureBytes = mod_js_1.Utils.toArray(this.signature, 'hex'); // ✅ Type assertion ensures it's a string
    ...
    async verify() {
        ...
        const { valid } = await verifier.verifySignature({
            signature: mod_js_1.Utils.toArray(signatureHex, 'hex'),
   ...
   */
    ...
    static getCertificateFieldEncryptionDetails(fieldName, serialNumber) {
        return {
            ...
            keyID: `${serialNumber !== null && serialNumber !== void 0 ? serialNumber : 'unknown'} ${fieldName}`
        };
    }
}
