...
exports.HTTPSOverlayLookupFacilitator = exports.DEFAULT_SLAP_TRACKERS = void 0;
...
class LookupResolver {
    constructor(config) {
        const defaultConfig = {
            ...
            slapTrackers: exports.DEFAULT_SLAP_TRACKERS,
            hostOverrides: {},
            additionalHosts: {}
        };
        const { facilitator = defaultConfig.facilitator, slapTrackers = defaultConfig.slapTrackers, hostOverrides = defaultConfig.hostOverrides, additionalHosts = defaultConfig.additionalHosts } = config !== null && config !== void 0 ? config : defaultConfig; // ✅ Use a default object directly
        this.facilitator = facilitator !== null && facilitator !== void 0 ? facilitator : new HTTPSOverlayLookupFacilitator();
        this.slapTrackers = slapTrackers !== null && slapTrackers !== void 0 ? slapTrackers : [];
        this.hostOverrides = hostOverrides !== null && hostOverrides !== void 0 ? hostOverrides : {};
        this.additionalHosts = additionalHosts !== null && additionalHosts !== void 0 ? additionalHosts : {};
    }
    /**
