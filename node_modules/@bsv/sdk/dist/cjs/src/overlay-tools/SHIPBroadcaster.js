...
class SHIPBroadcaster {
    ...
    constructor(topics, config) {
        ...
        this.topics = topics;
        const { facilitator, resolver, requireAcknowledgmentFromAllHostsForTopics, requireAcknowledgmentFromAnyHostForTopics, requireAcknowledgmentFromSpecificHostsForTopics } = config !== null && config !== void 0 ? config : {};
        this.facilitator = facilitator !== null && facilitator !== void 0 ? facilitator : new HTTPSOverlayBroadcastFacilitator();
        this.resolver = resolver !== null && resolver !== void 0 ? resolver : new LookupResolver_js_1.default();
        this.requireAcknowledgmentFromAllHostsForTopics =
            requireAcknowledgmentFromAllHostsForTopics !== null && requireAcknowledgmentFromAllHostsForTopics !== void 0 ? requireAcknowledgmentFromAllHostsForTopics : [];
        this.requireAcknowledgmentFromAnyHostForTopics =
            requireAcknowledgmentFromAnyHostForTopics !== null && requireAcknowledgmentFromAnyHostForTopics !== void 0 ? requireAcknowledgmentFromAnyHostForTopics : 'all';
        this.requireAcknowledgmentFromSpecificHostsForTopics =
            requireAcknowledgmentFromSpecificHostsForTopics !== null && requireAcknowledgmentFromSpecificHostsForTopics !== void 0 ? requireAcknowledgmentFromSpecificHostsForTopics : {};
    }
    /**
...
exports.default = SHIPBroadcaster;
